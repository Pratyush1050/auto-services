                                    ...
                                    <td class="px-2 py-3 border">
                                      <div class="flex items-center text-sm">
                                        <div class="relative w-1/2 h-1/2 mr-3  md:block">
                                          <img class="object-cover w-full h-full " src="{{asset('storage/service/'.$service->image)}}" alt="" loading="lazy" />
                                          <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                        </div>
                                      </div>
                                    </td>
                                    <td class="py-3 text-ms font-semibold border">{{$service->description}}</td>
                                    <td class="mx-4 py-3 text-xs border">
                                        <a href="{{route('admin.services.edit',$service->id)}}" class="pl-3">
