                            ...
                            <table class="w-full">
                              ...
                              <tbody class="bg-white">
                                  ...
                                  <tr class="text-gray-700">
                                    <td class="px-4 py-3 border">
                                      <div class="flex items-center text-sm">
                                        <div class="relative w-8 h-8 mr-3 rounded-full md:block">
                                          <img class="object-cover w-full h-full rounded-full" src="{{asset('storage/testimonial/'.$testimonial->image)}}" alt="" loading="lazy" />
                                    ...
                                    <td class="px-4 py-3 text-ms font-semibold border">{{$testimonial->limitDescription()}}</td>
