                    ...
                    <form action="{{route('admin.contacts.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="p-5 flex flex-col">
                            ...
                            @enderror" >
                                ...
                                <option value="telephone" {{old('contactType') == "telephone" ? 'selected':''}}>Telephone</option>
                                <option value="mobile" {{old('contactType') == "mobile" ? 'selected':''}}>Mobile</option>
                                <option value="fax" {{old('contactType') == "fax" ? 'selected':''}}>Fax</option>
                            </select>
                            @error('contactType')
